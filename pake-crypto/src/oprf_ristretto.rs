...
mod tests {
    ...
    fn test_vector_1() {
        ...
        let expected_blinded = hex("609a0ae68c15a3cf6903766461307e5c8bb2f95e7e6550e1ffa2dc99e412803c");
        ...
        // Blind
        let blind = Scalar::from_canonical_bytes(
            blind_bytes.as_slice().try_into().unwrap(),
        )
        .into_option()
        .unwrap();
    ...
    fn test_vector_2() {
        ...
        let blind_bytes = hex("64d37aed22a27f5191de1c1d69fadb899d8862b58eb4220029e036ec4c1f6706");
        let expected_blinded = hex("da27ef466870f5f15296299850aa088629945a17d1f5b7f5ff043f76b3c06418");
    ...
    fn different_keys_different_outputs() {
        ...
        let (state1, blinded1) =
            Ristretto255Oprf::client_blind(b"password", &mut OsRng).unwrap();
